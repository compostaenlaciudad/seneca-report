    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <section style={{ padding: '0 28px 64px', maxWidth: 1080, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 16 }}>
          <Kicker>Expediente del día</Kicker>
          <Mono size={10} color="var(--muted)">Actualizado hace 3 días</Mono>
        </div>
        ...
        >
          ...
          <div style={{ padding: '32px 28px' }}>
            ...
            >
              Patrimonio declarado creció{' '}
              <strong style={{ color: 'var(--text)' }}>+232%</strong> entre 2018 y
              2023. Tres conflictos de interés no declarados. Votó en contra de
              la reforma judicial que él mismo co-autoró.
            </p>
            <DimensionBars dimensions={featured.dimensions} compact />
            <Link
              href={`/politico/${featured.slug}`}
              style={{
                marginTop: 18,
                display: 'inline-flex',
                alignItems: 'center',
      ...
      >
        ...
        <Mono size={10} color="var(--muted)">v.12.3 · build 8a3f21</Mono>
      </footer>
    </div>
  );
}
